...
- **Wi-Fi gaming mode**: `nebel-wifi-perf.service` гасит power_save на
  всех Wi-Fi-интерфейсах при загрузке — убирает латентные всплески ath11k,
  критично для стриминга/DUO-беспроводного экрана/WiVRn. Выключению —
  `systemctl disable nebel-wifi-perf`.
